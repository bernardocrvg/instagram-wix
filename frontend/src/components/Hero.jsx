    ...
    <section className="relative pt-20 pb-16 md:pt-32 md:pb-24 overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10 text-center">
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-primary/10 text-primary text-sm font-medium mb-6">
          <Sparkles size={14} />
          <span>Novo: Filtro por Hashtags</span>
        </div>
        
        <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight mb-6 max-w-4xl mx-auto leading-tight">
          Incorpore Feeds do Instagram no <span className="text-gradient-primary">Wix</span> em Segundos
        </h1>
        
        <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-10 leading-relaxed">
          Crie feeds bonitos e responsivos para seu site Wix sem programar. 
          Filtre por hashtag, personalize o layout e copie o código.
        </p>
